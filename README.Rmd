...
The cleaned dataset (with some manual coding) can be found here: `data/dates_dat.csv` and can be merged into the main dataset via the image link. If you prefer the merged dataset then you can use `date/oryx_data_dates.csv`.
